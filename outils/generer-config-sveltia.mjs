...
const pageAccueil = {
  ...
  fields: [
    ...
    objet("hero", "Bandeau d'ouverture (hero)", [
      ...
      t("bouton_secondaire", "Bouton secondaire"),
    ]),
    ...
    objet("journal", "Bloc Journal", [
      t("surtitre", "Surtitre"),
      t("titre", "Titre"),
      long("texte", "Chapô", "Repris du haut de la page « Le Journal »."),
      t("bouton_tous", "Bouton « Tous les articles »"),
    ]),
